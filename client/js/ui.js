        ...
        return `
            <article class="item-card">
                <a href="item-detail.html?id=${encodeURIComponent(item.id)}" class="item-card-link">
                    <div class="item-image"><img src="${imageSrc(item.image)}" alt="${escapeHtml(item.name)}"></div>
            ...
            <div class="container navbar-inner">
                ...
                <div class="nav-actions">
                    ${user ? `
                        ...
                        <a href="profile.html" class="profile-button"><span class="mini-avatar">${escapeHtml(user.name.charAt(0).toUpperCase())}</span><span>${escapeHtml(user.name.split(" ")[0])}</span></a>
                    ` : `
